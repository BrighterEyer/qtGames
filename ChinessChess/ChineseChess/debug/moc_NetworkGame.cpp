...
QT_INIT_METAOBJECT const QMetaObject NetworkGame::staticMetaObject = { {
    &ChessBoard::staticMetaObject,
    qt_meta_stringdata_NetworkGame.data,
    qt_meta_data_NetworkGame,
    qt_static_metacall,
    nullptr,
    nullptr
} };
